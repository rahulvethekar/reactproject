				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
							<li><Link to ="/Login"><i class="fa fa-user"></i> Account</Link></li>
								<li><Link to ="/ProductDetails"><i class="fa fa-star"></i> Wishlist</Link></li>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><Link to = "/Shop" >Products<i class="fa fa-angle-down"></i></Link>
								...
								<li class="dropdown"><Link to="/Blog" class="active">Blog<i class="fa fa-angle-down"></i></Link>
                                    <ul role="menu" class="sub-menu">
                                        <li><Link to="/Blog" class="active">Blog List</Link></li>
										<li><Link to="/BlogSingle"  >Blog Single</Link></li>
                                    </ul>
                                </li> 
								<li><Link to = "/errorfile">404</Link></li>
