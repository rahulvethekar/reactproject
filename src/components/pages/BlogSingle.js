							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><Link to="/Blog" >Blog<i class="fa fa-angle-down"></i></Link>
                                    <ul role="menu" class="sub-menu">
										...
										<li><Link to="/BlogSingle"  class="active">Blog Single</Link></li>
                                    </ul>
                                </li> 
				...
				<div class="col-sm-9">
					...
					<div class="media commnets">
						<a class="pull-left" href="#">
							<img class="media-object" src="assets/images/blog/man-one.jpg" alt=""/>
						</a>
					...
					<div class="response-area">
						...
						<ul class="media-list">
							<li class="media">
								...
								<a class="pull-left" href="#">
									<img class="media-object" src="assets/images/blog/man-two.jpg" alt=""/>
								</a>
								<div class="media-body">
